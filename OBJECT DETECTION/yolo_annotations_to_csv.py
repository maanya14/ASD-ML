# A dataset preprocessing script for object detection.

# What It Does:
# - Reads YOLO .txt label files
# - Extracts: class_id, bounding box coordinates
# - Converts them into: annotations_all.csv

# What This Is
# - Data preprocessing script.
# - It prepares detection annotations for analysis.
...
if df.empty:
    print("No annotations found. CSV will be empty.")
else:
