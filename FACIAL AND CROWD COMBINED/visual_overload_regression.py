# Continuous overload probability model using classical regression.
# A regression model that predicts overload probability from visual features.
# What This Code Is REALLY Doing: 
# - Taking crowd + facial signals
# - Creating a weighted formula
# - Using that as pseudo-label
# - Training a linear regression model to learn that same formula
